...
# The following example shows how to integrate pyinotify with an DA
...
#  bash# TRACE=FileWatcher*,DASdkFd* ./InotifyExample.py /tmp/foobar.txt
...
class FileWatcher(DAsdk_utils.DASdkAgent,
                  DAsdk.AgentHandler,
                  DAsdk.FdHandler):
...
if __name__ == "__main__":
   ...
   parser = argparse.ArgumentParser(
      description="Watch a file for changes using DA SDK's `fd` module.")
