...
class echobot_worker : public stream_handler,
 ...
 public:
   echobot_worker(DA::sdk & sdk, echobot_server * parent, int fd) : 
      ...
      timeout_time_is(DA::now() + IDLE_CONNECTION_TIMEOUT);
   }
...
class echobot_server : public DA::agent_handler,
 ...
 public:
   ...
   explicit echobot_server(DA::sdk & sdk) :
...
echobot_worker::on_connection_closed() {
   ...
   // parent's data structure, DA SDK agents are single threaded!
