...
class NexthopGroupSyncer : public DA::nexthop_group_handler {
 public:
   explicit NexthopGroupSyncer(DA::nexthop_group_mgr * nhgm)
         : DA::nexthop_group_handler(nhgm),
   ...
   void nexthop_group_set(DA::nexthop_group_t const & nexthop_group) {
