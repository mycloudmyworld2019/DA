...
#ifndef DA_DECAP_GROUP_H
#define DA_DECAP_GROUP_H
...
#include <DA/types/decap_group.h>
 ...
 * DA::decap_group_t tunnel("gre_tunnel1",
 *                           DA::ip_addr_t("172.12.0.1"),
 *                           DA::PROTOCOL_TYPE_GRE);
...
class DA_SDK_PUBLIC decap_group_iter_t : public iter_base<decap_group_t,
                                                           decap_group_iter_impl> {
 private:
   friend class decap_group_iter_impl;
   explicit decap_group_iter_t(decap_group_iter_impl * const) DA_SDK_PRIVATE;
};
 ...
 * is valid for use.
 */
class DA_SDK_PUBLIC decap_group_mgr {
 public:
 ...
 protected:
   decap_group_mgr() DA_SDK_PRIVATE;
 private:
   DA_SDK_DISALLOW_COPY_CTOR(decap_group_mgr);
};

}

#endif // DA_DECAP_GROUP_H
