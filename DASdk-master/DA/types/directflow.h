...
#ifndef DA_TYPES_DIRECTFLOW_H
#define DA_TYPES_DIRECTFLOW_H
...
class DA_SDK_PUBLIC flow_match_field_set_t {
 public:
...
class DA_SDK_PUBLIC flow_match_t {
 public:
   flow_match_t();
...
class DA_SDK_PUBLIC flow_action_set_t {
 public:
   flow_action_set_t();
...
class DA_SDK_PUBLIC flow_action_t {
 public:
   flow_action_t();
...
class DA_SDK_PUBLIC flow_entry_t {
 public:
   flow_entry_t();
...
class DA_SDK_PUBLIC flow_counters_t {
 public:
   flow_counters_t();
...
#include <DA/inline/types/directflow.h>

#endif // DA_TYPES_DIRECTFLOW_H
