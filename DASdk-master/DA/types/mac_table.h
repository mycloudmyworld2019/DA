...
#ifndef DA_TYPES_MAC_TABLE_H
#define DA_TYPES_MAC_TABLE_H
...
class DA_SDK_PUBLIC mac_entry_t {
 public:
   /** Default constructor. */
   mac_entry_t();
...
#include <DA/inline/types/mac_table.h>

#endif // DA_TYPES_MAC_TABLE_H
