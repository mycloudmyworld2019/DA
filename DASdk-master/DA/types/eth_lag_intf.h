...
#ifndef DA_TYPES_ETH_LAG_INTF_H
#define DA_TYPES_ETH_LAG_INTF_H
 ...
 */
class DA_SDK_PUBLIC eth_lag_intf_membership_t {
 public:
 ...
 */
class DA_SDK_PUBLIC eth_lag_intf_t {
 public:
   eth_lag_intf_t();
...
#include <DA/inline/types/eth_lag_intf.h>

#endif // DA_TYPES_ETH_LAG_INTF_H
