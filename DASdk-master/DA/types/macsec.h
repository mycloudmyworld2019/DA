...
#ifndef DA_TYPES_MACSEC_H
#define DA_TYPES_MACSEC_H
...
class DA_SDK_PUBLIC macsec_key_t {
 public:
   macsec_key_t();
...
class DA_SDK_PUBLIC macsec_profile_t {
 public:
   macsec_profile_t();
...
class DA_SDK_PUBLIC macsec_intf_status_t {
 public:
...
class DA_SDK_PUBLIC macsec_intf_counters_t {
 public:
...
#include <DA/inline/types/macsec.h>

#endif // DA_TYPES_MACSEC_H
