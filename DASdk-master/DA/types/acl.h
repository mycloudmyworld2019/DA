...
#ifndef DA_TYPES_ACL_H
#define DA_TYPES_ACL_H
 ...
 */
class DA_SDK_PUBLIC acl_ttl_spec_t {
 public:
   acl_ttl_spec_t();
 ...
 */
class DA_SDK_PUBLIC acl_port_spec_t {
 public:
 ...
 */
class DA_SDK_PUBLIC acl_rule_base_t {
 public:
 ...
 protected:
   acl_rule_base_t() DA_SDK_PRIVATE;
...
class DA_SDK_PUBLIC acl_rule_ip_t : public acl_rule_base_t {
 public:
   acl_rule_ip_t();
...
class DA_SDK_PUBLIC acl_rule_eth_t : public acl_rule_base_t {
 public:
   acl_rule_eth_t();
...
#include <DA/inline/types/acl.h>

#endif // DA_TYPES_ACL_H
