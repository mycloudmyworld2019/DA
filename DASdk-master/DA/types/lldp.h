...
#ifndef DA_TYPES_LLDP_H
#define DA_TYPES_LLDP_H
...
class DA_SDK_PUBLIC lldp_tlv_type_t {
 public:
   lldp_tlv_type_t();
...
class DA_SDK_PUBLIC lldp_std_tlv_type_t {
 public:
   lldp_std_tlv_type_t();
...
class DA_SDK_PUBLIC lldp_syscap_t {
 public:
   lldp_syscap_t();
...
class DA_SDK_PUBLIC lldp_management_address_t {
 public:
...
class DA_SDK_PUBLIC lldp_lacp_t {
 public:
   lldp_lacp_t();
...
class DA_SDK_PUBLIC lldp_phy_t {
 public:
   lldp_phy_t();
...
class DA_SDK_PUBLIC lldp_chassis_id_t {
 public:
   lldp_chassis_id_t();
...
class DA_SDK_PUBLIC lldp_intf_id_t {
 public:
   lldp_intf_id_t();
...
class DA_SDK_PUBLIC lldp_remote_system_t {
 public:
...
class DA_SDK_PUBLIC lldp_neighbor_t {
 public:
   lldp_neighbor_t();
...
#include <DA/inline/types/lldp.h>

#endif // DA_TYPES_LLDP_H
