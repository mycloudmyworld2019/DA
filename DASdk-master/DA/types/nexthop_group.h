...
#ifndef DA_TYPES_NEXTHOP_GROUP_H
#define DA_TYPES_NEXTHOP_GROUP_H
 ...
 * those labels, such as DA::MPLS_ACTION_PUSH.
 */
class DA_SDK_PUBLIC nexthop_group_mpls_action_t {
 public:
   /** Default constructor. */
...
class DA_SDK_PUBLIC nexthop_group_entry_counter_t {
 public:
 ...
 */
class DA_SDK_PUBLIC nexthop_group_entry_t {
 public:
 ...
 */
class DA_SDK_PUBLIC nexthop_group_t {
 public:
   nexthop_group_t();
...
#include <DA/inline/types/nexthop_group.h>

#endif // DA_TYPES_NEXTHOP_GROUP_H
