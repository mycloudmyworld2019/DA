...
#ifndef DA_TYPES_BFD_H
#define DA_TYPES_BFD_H
 ...
 */
class DA_SDK_PUBLIC bfd_session_key_t {
 public:
   bfd_session_key_t();
 ...
 */
class DA_SDK_PUBLIC bfd_interval_t {
 public:
   bfd_interval_t();
...
class DA_SDK_PUBLIC bfd_session_t {
 public:
   bfd_session_t();
...
#include <DA/inline/types/bfd.h>

#endif // DA_TYPES_BFD_H
