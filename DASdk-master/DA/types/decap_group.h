...
#ifndef DA_TYPES_DECAP_GROUP_H
#define DA_TYPES_DECAP_GROUP_H
 ...
 */
class DA_SDK_PUBLIC decap_group_t {
 public:
   decap_group_t();
...
#include <DA/inline/types/decap_group.h>

#endif // DA_TYPES_DECAP_GROUP_H
