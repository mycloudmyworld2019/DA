...
#ifndef DA_TYPES_ETH_H
#define DA_TYPES_ETH_H
...
class DA_SDK_PUBLIC vlan_set_t: public std::bitset<4096> {
};

/// A deprecated alias. Use DA::vlan_set_t instead.
...
/** An Ethernet address. */
class DA_SDK_PUBLIC eth_addr_t {
 public:
   /**
...
class DA_SDK_PUBLIC invalid_vlan_error : public error {
 public:
...
class DA_SDK_PUBLIC internal_vlan_error : public configuration_error {
 public:
...
#include <DA/inline/types/eth.h>

#endif // DA_TYPES_ETH_H
