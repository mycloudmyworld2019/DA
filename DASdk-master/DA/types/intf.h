...
#ifndef DA_TYPES_INTF_H
#define DA_TYPES_INTF_H
...
class DA_SDK_PUBLIC intf_id_t {
 public:
    ...
    */
   explicit intf_id_t(uint64_t) DA_SDK_INTERNAL;
 ...
 */
class DA_SDK_PUBLIC intf_counters_t {
 public:
   intf_counters_t();
...
class DA_SDK_PUBLIC intf_traffic_rates_t {
 public:
...
class DA_SDK_PUBLIC no_such_interface_error : public error {
 public:
 ...
 */
class DA_SDK_PUBLIC not_switchport_eligible_error : public error {
 public:
...
#include <DA/inline/types/intf.h>

#endif // DA_TYPES_INTF_H
