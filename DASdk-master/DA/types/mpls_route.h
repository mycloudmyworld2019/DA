...
#ifndef DA_TYPES_MPLS_ROUTE_H
#define DA_TYPES_MPLS_ROUTE_H
...
class DA_SDK_PUBLIC mpls_route_key_t {
 public:
   mpls_route_key_t();
   /**
...
class DA_SDK_PUBLIC mpls_route_t {
 public:
...
class DA_SDK_PUBLIC mpls_route_via_t {
 public:
   mpls_route_via_t();
 ...
 */
class DA_SDK_PUBLIC mpls_fec_id_t {
 public:
   mpls_fec_id_t();
...
#include <DA/inline/types/mpls_route.h>

#endif // DA_TYPES_MPLS_ROUTE_H
