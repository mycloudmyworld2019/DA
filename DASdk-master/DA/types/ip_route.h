...
#ifndef DA_TYPES_IP_ROUTE_H
#define DA_TYPES_IP_ROUTE_H
...
class DA_SDK_PUBLIC ip_route_key_t {
 public:
   ip_route_key_t();
 ...
 * route key.
 */
class DA_SDK_PUBLIC ip_route_t {
 public:
   ip_route_t();
 ...
 * interface is Null0.
 */
class DA_SDK_PUBLIC ip_route_via_t {
 public:
   ip_route_via_t();
...
#include <DA/inline/types/ip_route.h>

#endif // DA_TYPES_IP_ROUTE_H
