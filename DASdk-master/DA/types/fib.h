...
#ifndef DA_TYPES_FIB_H
#define DA_TYPES_FIB_H
...
class DA_SDK_PUBLIC fib_route_key_t {
 public:
   fib_route_key_t();
...
enum fib_route_type_t {
   ...
   ROUTE_TYPE_IBGP,
   ROUTE_TYPE_EBGP,
   /** Unused in DA 4.15.1, use ROUTE_TYPE_ISIS_LEVEL1/2 instead. */
   ROUTE_TYPE_ISIS,
 ...
 */
class DA_SDK_PUBLIC fib_route_t {
 public:
   fib_route_t();
...
class DA_SDK_PUBLIC fib_fec_key_t {
 public:
   fib_fec_key_t();
...
#include <DA/inline/types/fib.h>

#endif // DA_TYPES_FIB_H
