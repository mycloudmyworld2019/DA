...
#ifndef DA_TYPES_NEIGHBOR_TABLE_H
#define DA_TYPES_NEIGHBOR_TABLE_H
 ...
 */
class DA_SDK_PUBLIC neighbor_key_t {
 public:
   neighbor_key_t();
...
class DA_SDK_PUBLIC neighbor_entry_t {
 public:
   neighbor_entry_t();
...
#include <DA/inline/types/neighbor_table.h>

#endif // DA_TYPES_NEIGHBOR_TABLE_H
