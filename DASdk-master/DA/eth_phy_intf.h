...
#ifndef DA_ETH_PHY_INTF_H
#define DA_ETH_PHY_INTF_H
...
#include <DA/types/eth_phy_intf.h>
 ...
 */
class DA_SDK_PUBLIC eth_phy_intf_handler
...
class DA_SDK_PUBLIC eth_phy_intf_iter_t : public iter_base<intf_id_t,
                                                            eth_phy_intf_iter_impl> {
 private:
   friend class eth_phy_intf_iter_impl;
   explicit eth_phy_intf_iter_t(eth_phy_intf_iter_impl * const) DA_SDK_PRIVATE;
};


class DA_SDK_PUBLIC eth_phy_intf_mgr : public base_mgr<eth_phy_intf_handler,
                                                        intf_id_t> {
 public:
 ...
 protected:
   eth_phy_intf_mgr() DA_SDK_PRIVATE;
   friend class eth_phy_intf_handler;
 private:
   DA_SDK_DISALLOW_COPY_CTOR(eth_phy_intf_mgr);
};
 ...
 */
class DA_SDK_PUBLIC eth_phy_intf_counter_mgr {
 public:
 ...
 protected:
   eth_phy_intf_counter_mgr() DA_SDK_PRIVATE;
   
 private:
   DA_SDK_DISALLOW_COPY_CTOR(eth_phy_intf_counter_mgr);
};


}

#include <DA/inline/eth_phy_intf.h>

#endif // DA_ETH_PHY_INTF_H
