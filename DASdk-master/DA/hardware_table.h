...
#ifndef DA_HARDWARE_TABLE_H
#define DA_HARDWARE_TABLE_H
...
#include <DA/types/hardware_table.h>
 ...
 */
class DA_SDK_PUBLIC hardware_table_handler : 
 ...
 */
class DA_SDK_PUBLIC hardware_table_iter_t : 
 ...
 * function is called.
 */
class DA_SDK_PUBLIC hardware_table_mgr : 
 ...
 protected:
   hardware_table_mgr() DA_SDK_PRIVATE;
   friend class hardware_table_handler;
   
 private:
   DA_SDK_DISALLOW_COPY_CTOR(hardware_table_mgr);
};

} // end namespace DA

#include <DA/inline/hardware_table.h>


#endif // DA_HARDWARE_TABLE_H
