...
#ifndef DA_ETH_INTF_H
#define DA_ETH_INTF_H
 ...
 */
class DA_SDK_PUBLIC eth_intf_handler : public base_handler<eth_intf_mgr,
                                                            eth_intf_handler> {
 public:
...
class DA_SDK_PUBLIC eth_intf_iter_t : public iter_base<intf_id_t,
                                                        eth_intf_iter_impl> {
 private:
   friend class eth_intf_iter_impl;
   explicit eth_intf_iter_t(eth_intf_iter_impl * const) DA_SDK_PRIVATE;
};


/// The ethernet interface manager
class DA_SDK_PUBLIC eth_intf_mgr : public base_mgr<eth_intf_handler, intf_id_t> {
 public:
 ...
 protected:
   eth_intf_mgr() DA_SDK_PRIVATE;
   friend class eth_intf_handler;

 private:
   DA_SDK_DISALLOW_COPY_CTOR(eth_intf_mgr);
};

}

#include <DA/inline/eth_intf.h>
