...
#ifndef DA_MPLS_ROUTE_H
#define DA_MPLS_ROUTE_H
 ...
 * in the hardware.
 **/
class DA_SDK_PUBLIC mpls_route_handler : public base_handler<mpls_route_mgr,
                                                              mpls_route_handler> {
 public:
...
class DA_SDK_PUBLIC mpls_route_via_status_iter_t :
  ...
  private:
    ...
    explicit mpls_route_via_status_iter_t(
          mpls_route_via_status_iter_impl * const) DA_SDK_PRIVATE;
 };

/// The IP static route manager
class DA_SDK_PUBLIC mpls_route_mgr : public base_mgr<mpls_route_handler, 
                                                     mpls_label_t> {
  public:
 ...
 protected:
   mpls_route_mgr() DA_SDK_PRIVATE;
   friend class mpls_route_handler;
 private:
   DA_SDK_DISALLOW_COPY_CTOR(mpls_route_mgr);
};

} // end namespace DA

#include <DA/inline/mpls_route.h>

#endif // DA_MPLS_ROUTE_H
