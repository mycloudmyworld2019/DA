 ...
 */
class DA_SDK_PUBLIC ip_intf_handler : public base_handler<ip_intf_mgr,
                                                           ip_intf_handler> {
 public:
...
class DA_SDK_PUBLIC ip_intf_mgr : public base_mgr<ip_intf_handler, intf_id_t> {
 public:
   virtual ~ip_intf_mgr();
 ...
 protected:
   ip_intf_mgr() DA_SDK_PRIVATE;
   friend class ip_intf_handler;

 private:
   DA_SDK_DISALLOW_COPY_CTOR(ip_intf_mgr);
};

}

#include <DA/inline/ip_intf.h>
