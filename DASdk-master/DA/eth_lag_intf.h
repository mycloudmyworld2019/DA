...
#ifndef DA_ETH_LAG_INTF_H
#define DA_ETH_LAG_INTF_H
...
#include <DA/types/eth_lag_intf.h>
...
class DA_SDK_PUBLIC eth_lag_intf_handler : public base_handler<
 ...
 */
class DA_SDK_PUBLIC eth_lag_intf_iter_t : public iter_base< intf_id_t,
                                                  eth_lag_intf_iter_impl> {
 private:
   friend class eth_lag_intf_iter_impl;
   explicit eth_lag_intf_iter_t(eth_lag_intf_iter_impl * const) DA_SDK_PRIVATE;
};
...
class DA_SDK_PUBLIC eth_lag_intf_mgr
 ...
 protected:
   eth_lag_intf_mgr() DA_SDK_PRIVATE;
   friend class eth_lag_intf_handler;

 private:
   DA_SDK_DISALLOW_COPY_CTOR(eth_lag_intf_mgr);
};

} // end namespace DA

#include <DA/inline/eth_lag_intf.h>

#endif // DA_ETH_LAG_INTF_H
