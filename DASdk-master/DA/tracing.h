 ...
 * Tracing facilities.
 * 
 * This modules allows SDK programs to integrate with DA's tracing
 ...
 * trace command can be found in the DA manual.
 * 
 ...
 * 0, 1, 2, and 3.
 *
 * You can view tracing for the SDK module by tracing DASdk*
 */
...
class DA_SDK_PUBLIC tracer {
 public:
   ...
   void trace(trace_level level, char const * expression, ...) const
      DA_SDK_FORMAT_STRING_CHECK(3);

   void trace0(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
   void trace1(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
   void trace2(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
   void trace3(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
   void trace4(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
   void trace5(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
   void trace6(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
   void trace7(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
   void trace8(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
   void trace9(char const * expression, ...) const DA_SDK_FORMAT_STRING_CHECK(2);
 private:
