...
#ifndef DA_CLASS_MAP_H
#define DA_CLASS_MAP_H
...
class DA_SDK_PUBLIC class_map_iter_t : public iter_base<class_map_key_t,
                                                         class_map_iter_impl> {
 private:
   friend class class_map_iter_impl;
   explicit class_map_iter_t(class_map_iter_impl * const) DA_SDK_PRIVATE;
};

/**
 * DA class map manager.
 *
 * This manager provides access to DA traffic classifiers, or "class
 ...
 */
class DA_SDK_PUBLIC class_map_mgr {
 public:
 ...
 protected:
   class_map_mgr() DA_SDK_PRIVATE;
 private:
   DA_SDK_DISALLOW_COPY_CTOR(class_map_mgr);
};

} // end namespace DA

#endif // DA_CLASS_MAP_H
