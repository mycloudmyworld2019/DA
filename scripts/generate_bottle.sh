...
mkdir -p ${PROJECT}/${VERSION}/opt/DAio/lib/cmake
...
echo "class DAio < Formula

   homepage \"${URL}\"
   revision 0
   url \"https://github.com/DAio/DA/archive/v${VERSION}.tar.gz\"
   version \"${VERSION}\"
   ...
   bottle do
      root_url \"https://github.com/DAio/DA/releases/download/v${VERSION}\"
